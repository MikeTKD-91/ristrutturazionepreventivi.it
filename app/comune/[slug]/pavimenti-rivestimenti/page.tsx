...
function buildJsonLd(comune: ReturnType<typeof getComuneBySlug>) {
  ...
  const pageUrl = `https://ristrutturazionepreventivi.it/comune/${comune.slug}/pavimenti-rivestimenti/`;
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Pavimenti e Rivestimenti", item: pageUrl },
    ],
  };
  const localBusiness = {
    ...
    description: `Posa pavimenti e rivestimenti a ${comune.nome}. Preventivi con sopralluogo, stime orientative gratuite.`,
  };
